...
public class MainActivity extends BaseActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, ISpiceManagerProvider {
    ...
    @Override
    public void onNavigationDrawerItemSelected(Enums.MainMenu type) {
        Fragment fragment = null;
        switch (type)
        {
            case POSTS:
                fragment = new PostsContainerFragment();
                break;
            case HUBS:
